<?php
	...
	if(isset($_GET['add_category']))
	{
		...
		if($result= $obj->sql_select($query))
		{
			...
			if($obj->sql_update($query))
			{
				...
				echo "Your category has been inserted successfully";
			}
			else
			{
	...
	if(isset($_GET['edit_category']))
	{
		...
		if($obj->sql_update($query))
		{
			echo "Your category has been updated successfully";
		}
		else
			{
				echo "There was some problem processing your request. Please try again later.";
	...
	if(isset($_GET['delete_category']))
	{
		...
		if($obj->sql_update($query))
		{
			echo "Your category has been deleted successfully";
		}
		else
			{
	...
	if(isset($_GET['add_product']))
	{
		...
		if($result= $obj->sql_select($query))
		{
			...
			if($obj->sql_update($query))
			{
				echo "Your product has been inserted successfully";
			}
			else
			{
				echo "There was some problem processing your request. Please try again later.";
		...
		if($result= $obj->sql_select($query))
		{
			...
			if($obj->sql_update($query))
			{
				echo "Your product features have been inserted successfully";
			}
			else
			{
				echo "There was some problem processing your request. Please try again later.";
...
//===================================================================================================================//
	...
	if(isset($_GET['edit_product']))
	{
		...
		$product_cost = $_GET['product_cost'];
		$product_quantity = $_GET['product_quantity'];
		$product_weight = $_GET['product_weig ht'];
		$product_model_no = $_GET['product_model_no'];
		$product_created_at = $_GET['product_created_at'];
		$search_keyword = $_GET['search_keyword'];
		$feature_name = $_GET['feature_name'];
		...
		$query = "Update `product` set
		    ...
		    if($obj->sql_update($query))
			{
				echo "Your product has been updated successfully";
			}
			else
			{
				echo "There was some problem processing your request. Please try again later.";
